...
export const sendMessagePortToChatMathWorker = async (port: MessagePort, rpcId: number): Promise<void> => {
  const command = 'HandleMessagePort.handleMessagePort'
  await invokeAndTransfer('SendMessagePortToExtensionHostWorker.sendMessagePortToChatMathWorker', port, command, rpcId)
}

export const sendMessagePortToChatCoordinatorWorker = async (port: MessagePort, rpcId: number): Promise<void> => {
  const command = 'HandleMessagePort.handleMessagePort'
...
export const sendMessagePortToTerminalProcess = async (port: MessagePort, rpcId: number): Promise<void> => {
...
export const sendMessagePortToChatStorageWorker = async (port: MessagePort, rpcId?: number): Promise<void> => {
